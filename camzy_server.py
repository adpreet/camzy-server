...
def get_default_cams():
    ...
    },
    {
        "id": "5",
        "name": "Soggy Dollar",
        "location": "British Virgin Island, Caribbean",
        "videoId": "V_I168MM-ik",
        "directUrl": "",
    ...
    {
        "id": "10",
        "name": "Jackson Hole Town Square-Northeast",
        "location": "Jackson Hole, Wyoming",
        "videoId": "Zj0pXlq2-jI",
        "directUrl": "",
        "timezone": "America/Denver",
    ...
    {
        "id": "15",
        "name": "Sag Harbor Hamptons",
        "location": "Sag Harbor Village, New York",
        "videoId": "sxZxz0OPoh0",
        "directUrl": "",
        "timezone": "America/New_York",
        "lat": 40.9998,
    ...
    },
    {
        "id": "26",
        "name": "Main Beach",
        "location": "East Hampton Village, New York",
        "videoId": "yLU8DNeXXmc",
        "directUrl": "",
        "timezone": "America/New_York",
        "lat": 40.9621,
    ...
    },
    {
        "id": "61",
        "name": "Sant Elm Beach",
        "location": "Sant Elm, Mallorca, Spain",
        "videoId": "9svQ7gvPGc0",
        "directUrl": "",
        "timezone": "Europe/Madrid",
        "lat": 39.5833,
    ...
    },
    {
        ...
        "location": "New York City, New York",
        "videoId": "",
        "directUrl": "https://cdn77.ptztv.live/eUBVKlrSqtUjJe_sM7wdiw==,1780901263/cdnorigin/nyhwmux.stream/chunklist_DVR.m3u8",
        "timezone": "America/New_York",
        "lat": 40.7128,
        "lon": -74.006,
        "category": "USA",
        "thumbnailOverride": "https://i.imgur.com/rXoM42Q.png"
    }
]
...
class Handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        # YouTube stream extraction (existing logic)
        video_id = path
